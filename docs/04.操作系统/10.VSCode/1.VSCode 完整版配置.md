...
也可以看看这些文章: [Visual Studio Code 权威指南-韩骏-微信读书](https://weread.qq.com/web/reader/7bc32db071f02f257bc2a8a)(如看不到内容, 请登陆微信读书网页版), [Visual Studio Code 入门(译) - 简书](https://www.jianshu.com/p/3dda4756eca5)
...
```json
{
  ...
  // 看板娘 插件名: vscode-live2d
  "vscode-live2d.model": "nepgear",
  "vscode-live2d.opacity": 0.7,
  "vscode-live2d.modelWidth": 224,
  "vscode-live2d.modelHeight": 200,
  "vscode-live2d.pointerPenetration": true,
  "vscode-live2d.moveX": -80
}
```
