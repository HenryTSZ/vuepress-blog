...
但其实 `import.*from\s'\.{1,2}(\/.+)` 已经就满足我们的需求了，只是还缺少前面一层路径，再使用括号创建一个子表达式就可以了：`import.*from\s'(\.{1,2}\/.+)`
...
```
match: import { useStore } from '../../store' p1: ../../store' p2: /../store'
match: import { format } from '../../../utils' p1: ../../../utils' p2: /../../utils'
match: import interface from './interface' p1: ./interface' p2: /interface'
match: import logo from '../../../assets/images/logo.png' p1: ../../../assets/images/logo.png' p2: /../../assets/images/logo.png'
```
